...
LOGGING_NAME = "ultralytics_bower"
...
class ThreadingLocked:
    ...
    Example:
        ```python
        from ultralytics_bower.utils import ThreadingLocked
...
class SettingsManager(dict):
    ...
    def __init__(self, file=SETTINGS_YAML, version="0.0.4"):
        ...
        from ultralytics_bower.utils.torch_utils import torch_distributed_zero_first
