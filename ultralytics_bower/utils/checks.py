...
def parse_requirements(file_path=ROOT.parent / "requirements.txt", package=""):
    ...
    Example:
        ```python
        from ultralytics_bower.utils.checks import parse_requirements
...
def collect_system_info():
    ...
    from ultralytics_bower.utils import ENVIRONMENT, is_git_dir
    from ultralytics_bower.utils.torch_utils import get_cpu_info
...
def check_amp(model):
    ...
    Example:
        ...
        from ultralytics_bower.utils.checks import check_amp
