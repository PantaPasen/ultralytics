...
Usage:
    from ultralytics_bower.utils.benchmarks import ProfileModels, benchmark
...
from ultralytics_bower import YOLO, YOLOWorld
from ultralytics_bower.cfg import TASK2DATA, TASK2METRIC
from ultralytics_bower.engine.exporter import export_formats
from ultralytics_bower.utils import ASSETS, LINUX, LOGGER, MACOS, TQDM, WEIGHTS_DIR
from ultralytics_bower.utils.checks import IS_PYTHON_3_12, check_requirements, check_yolo
from ultralytics_bower.utils.files import file_size
from ultralytics_bower.utils.torch_utils import select_device
...
class ProfileModels:
    ...
    Example:
        ```python
        from ultralytics_bower.utils.benchmarks import ProfileModels
