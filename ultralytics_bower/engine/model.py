...
from ultralytics_bower.cfg import TASK2DATA, get_cfg, get_save_dir
from ultralytics_bower.hub.utils import HUB_WEB_ROOT
from ultralytics_bower.nn.tasks import attempt_load_one_weight, guess_model_task, nn, yaml_model_load
from ultralytics_bower.utils import ASSETS, DEFAULT_CFG_DICT, LOGGER, RANK, SETTINGS, callbacks, checks, emojis, yaml_load
...
class Model(nn.Module):
    ...
    Args:
        model (Union[str, Path], optional): Path or name of the model to load or create. This can be a local file
            path, a model name from ultralytics_bower HUB, or a Triton Server model. Defaults to 'yolov8n.pt'.
    ...
    def __init__(
        ...
        Args:
            model (Union[str, Path], optional): The path or model file to load or create. This can be a local
                file path, a model name from ultralytics_bower HUB, or a Triton Server model. Defaults to 'yolov8n.pt'.
    ...
    def _get_hub_session(model: str):
        ...
        from ultralytics_bower.hub.session import HUBTrainingSession
    ...
    def save(self, filename: Union[str, Path] = "saved_model.pt", use_dill=True) -> None:
        ...
        """
        self._check_is_pytorch_model()
        from ultralytics_bower import __version__
    ...
    def track(
        ...
        **kwargs,
        ...
        if not hasattr(self.predictor, "trackers"):
            from ultralytics_bower.trackers import register_tracker
    ...
    def benchmark(
        ...
        **kwargs,
        ...
        """
        self._check_is_pytorch_model()
        from ultralytics_bower.utils.benchmarks import benchmark
    ...
    def tune(
        ...
        **kwargs,
        ...
        self._check_is_pytorch_model()
        if use_ray:
            from ultralytics_bower.utils.tuner import run_ray_tune
