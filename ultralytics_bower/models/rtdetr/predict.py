...
from ultralytics_bower.data.augment import LetterBox
from ultralytics_bower.engine.predictor import BasePredictor
from ultralytics_bower.engine.results import Results
from ultralytics_bower.utils import ops
...
class RTDETRPredictor(BasePredictor):
    ...
    Example:
        ```python
        from ultralytics_bower.utils import ASSETS
        from ultralytics_bower.models.rtdetr import RTDETRPredictor
