...
!!! Example "View settings"
    ...
    === "Python"
        ...
        ```python
        from ultralytics_bower import settings
...
|--------------------|-----------------------|-----------|------------------------------------------------------------------------------------------------------------------|
| `settings_version` | `'0.0.4'`             | `str`     | Ultralytics _settings_ version (different from ultralytics_bower [pip](https://pypi.org/project/ultralytics/) version) |
